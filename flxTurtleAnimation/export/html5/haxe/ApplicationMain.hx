...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("flxTurtleAnimation", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("flxTurtleAnimation", null, 1024, 765);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "flxTurtleAnimation";
		app.meta["name"] = "flxTurtleAnimation";
